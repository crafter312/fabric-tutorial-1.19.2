...
public class ModStructures {
    ...
    public static void registerStructureFeatures() {
        SKY_STRUCTURES = register("sky_structures", SkyStructures.CODEC);
    }
    ...
    private static <S extends Structure> StructureType<S> register(String name, Codec<S> codec) {
        return Registry.register(Registry.STRUCTURE_TYPE, new Identifier(TutorialMod.MOD_ID, name), () -> codec);
    }
