package net.thesquire.tutorialmod.world.structure;

import net.minecraft.world.gen.GenerationStep;
import net.minecraft.world.gen.feature.StructureFeature;
import net.thesquire.tutorialmod.TutorialMod;
import net.thesquire.tutorialmod.mixin.StructureFeatureAccessor;
...
public class ModStructures {
    ...
    public static void registerStructureFeatures() {
        ...
        StructureFeatureAccessor.callRegister(TutorialMod.MOD_ID + ":sky_structures", SKY_STRUCTURES, GenerationStep.Feature.SURFACE_STRUCTURES);
    }
