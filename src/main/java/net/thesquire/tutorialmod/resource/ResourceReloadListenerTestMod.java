...
public class ResourceReloadListenerTestMod implements ModInitializer {
    ...
    private void setupClientReloadListeners() {
        ResourceManagerHelper.get(ResourceType.CLIENT_RESOURCES).registerReloadListener(new SimpleSynchronousResourceReloadListener() {
            ...
            public Identifier getFabricId() {
                return new Identifier(TutorialMod.MOD_ID, "client_second");
            }
            ...
            public Collection<Identifier> getFabricDependencies() {
                return Collections.singletonList(new Identifier(TutorialMod.MOD_ID, "client_first"));
            }
        });
        ...
        ResourceManagerHelper.get(ResourceType.CLIENT_RESOURCES).registerReloadListener(new SimpleSynchronousResourceReloadListener() {
            @Override
            public Identifier getFabricId() {
                return new Identifier(TutorialMod.MOD_ID, "client_first");
            }
    ...
    private void setupServerReloadListeners() {
        ResourceManagerHelper.get(ResourceType.SERVER_DATA).registerReloadListener(new SimpleSynchronousResourceReloadListener() {
            @Override
            public Identifier getFabricId() {
                return new Identifier(TutorialMod.MOD_ID, "server_second");
            }
            ...
            @Override
            public Collection<Identifier> getFabricDependencies() {
                return Collections.singletonList(new Identifier(TutorialMod.MOD_ID, "server_first"));
            }
        });
        ...
        ResourceManagerHelper.get(ResourceType.SERVER_DATA).registerReloadListener(new SimpleSynchronousResourceReloadListener() {
            @Override
            public Identifier getFabricId() {
                return new Identifier(TutorialMod.MOD_ID, "server_first");
            }
