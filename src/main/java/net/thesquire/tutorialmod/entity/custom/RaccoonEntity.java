package net.thesquire.tutorialmod.entity.custom;
...
import net.thesquire.tutorialmod.entity.variant.RaccoonVariant;
...
public class RaccoonEntity extends TameableEntity implements IAnimatable {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if (isBreedingItem(itemstack)) return super.interactMob(player, hand);
